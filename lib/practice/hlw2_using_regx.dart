...
class Hlw2Regx extends StatefulWidget {
  const Hlw2Regx({Key? key}) : super(key: key);

  @override
  State<Hlw2Regx> createState() => _Hlw2RegxState();
}

class _Hlw2RegxState extends State<Hlw2Regx> {
  bool? check1 = true, signUP=false,signUp1=false;
  final _formKey= GlobalKey<FormState>();
  RegExp pass_valid = RegExp(r"((?=.*\d)(?=.*[a-z])(?=.*[A-Z])(?=.*\W)){10,}");
  RegExp pass_valid_email= RegExp(r"^[a-zA-Z0-9.a-zA-Z0-9.!#$%&'*+-/=?^_`{|}~]+@[a-zA-Z0-9]+\.[a-zA-Z]+");
      ...
      body: Container(
        ...
        child: Form(
          ...
          child: Column(
            ...
            children: [
              _welcomeText(),//prints Welcome
              _latisha_betts(),//prints Latisha Betts
              _textEmail(),// a text named email is printed
              _sizeBox(),//size box of 20 height
              _textFormFieldOfEmail(),// a text Field for Email is produced
              _textPassword(),// a text named password is printed
              _textFormFieldOfPassword(),//a text Field for password is produced
              _sizeBox(),//size box of 20 height

              Row(
                children: [
                  _checkBox(),//check box with Remember me is created
                  _textButtonForgetPassword(),// Forget me text button is created
                ],
              ),
              _sizeBox(),//size box of 20 height
              _signInButton(),
